...
public class WaterTank : MonoBehaviour
{
    ...
    public TextMeshProUGUI mensajeAgua; // Mensaje temporal (ej. "Cubo de agua a�adido")
    ...
    public string itemName = "Cubo de Agua"; // Nombre del �tem
    public Sprite waterCuboIcon; // Icono del �tem
    ...
    void AddWaterToInventory()
    {
        if (playerInventory != null && hasCollectedWater)
        {
            ...
            if (success)
            {
                ...
                mensajeAgua.text = "Cubo de Agua a�adido al inventario.";
            }
            else
            {
                Debug.LogWarning("No se pudo a�adir Cubo de Agua al inventario.");
                mensajeAgua.text = "Se ha agotado el agua. Puedes fabricar m�s.";
            }
        }
